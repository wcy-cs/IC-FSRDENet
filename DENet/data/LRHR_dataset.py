...
class LRHRDataset(Dataset):
    def __init__(self, dataroot, datatype, name,l_resolution=16, r_resolution=256, split='train', data_len=-1, need_LR=False):
        ...
        if datatype == 'lmdb':
            ...
            self.sr_path = Util.get_paths_from_images(
                '{}/sr_{}_{}_{}'.format(dataroot, l_resolution, r_resolution, name))
    ...
    def __getitem__(self, index):
        ...
        if self.need_LR:
            ...
            return {'LR': img_LR, 'HR': img_HR, 'SR': img_SR, 'Index': index, 'filename':tempfilename}
        else:
